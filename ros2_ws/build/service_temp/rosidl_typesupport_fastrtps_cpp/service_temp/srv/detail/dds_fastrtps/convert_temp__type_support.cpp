...
#include "service_temp/srv/detail/convert_temp__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = service_temp::srv::ConvertTemp_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const service_temp::srv::ConvertTemp_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<service_temp::srv::ConvertTemp_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_service_temp
const rosidl_message_type_support_t *
get_message_type_support_handle<service_temp::srv::ConvertTemp_Request>()
{
  return &service_temp::srv::typesupport_fastrtps_cpp::_ConvertTemp_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = service_temp::srv::ConvertTemp_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const service_temp::srv::ConvertTemp_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<service_temp::srv::ConvertTemp_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &service_temp::srv::typesupport_fastrtps_cpp::_ConvertTemp_Response__handle;
}
...
{
  return &service_temp::srv::typesupport_fastrtps_cpp::_ConvertTemp__handle;
}
