...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /workspace/catkin_ws/src/turtlebot_simulator/turtlebot_gazebo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/catkin_ws/src/turtlebot_simulator/turtlebot_gazebo/${idir}'.  ${_report}")
    endif()
