...
{
  new (message_memory) service_temp::srv::ConvertTemp_Request(_init);
}

void ConvertTemp_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<service_temp::srv::ConvertTemp_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ConvertTemp_Request_message_member_array[2] = {
  {
    ...
    offsetof(service_temp::srv::ConvertTemp_Request, input_temp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(service_temp::srv::ConvertTemp_Request, conversion_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ConvertTemp_Request_message_members = {
  "service_temp::srv",  // message namespace
  "ConvertTemp_Request",  // message name
  2,  // number of fields
  sizeof(service_temp::srv::ConvertTemp_Request),
...
{
  return &::service_temp::srv::rosidl_typesupport_introspection_cpp::ConvertTemp_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, service_temp, srv, ConvertTemp_Request)() {
  return &::service_temp::srv::rosidl_typesupport_introspection_cpp::ConvertTemp_Request_message_type_support_handle;
}
...
void ConvertTemp_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) service_temp::srv::ConvertTemp_Response(_init);
}

void ConvertTemp_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<service_temp::srv::ConvertTemp_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ConvertTemp_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(service_temp::srv::ConvertTemp_Response, converted_temp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ConvertTemp_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(service_temp::srv::ConvertTemp_Response),
...
{
  return &::service_temp::srv::rosidl_typesupport_introspection_cpp::ConvertTemp_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, service_temp, srv, ConvertTemp_Response)() {
  return &::service_temp::srv::rosidl_typesupport_introspection_cpp::ConvertTemp_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers ConvertTemp_service_members = {
  "service_temp::srv",  // service namespace
  "ConvertTemp",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<service_temp::srv::ConvertTemp>()
...
get_service_type_support_handle<service_temp::srv::ConvertTemp>()
{
  ...
  auto service_type_support =
    &::service_temp::srv::rosidl_typesupport_introspection_cpp::ConvertTemp_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::service_temp::srv::ConvertTemp_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::service_temp::srv::ConvertTemp_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, service_temp, srv, ConvertTemp)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<service_temp::srv::ConvertTemp>();
}
