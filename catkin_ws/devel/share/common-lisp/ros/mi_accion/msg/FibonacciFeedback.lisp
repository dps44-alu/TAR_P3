...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mi_accion-msg:<FibonacciFeedback> is deprecated: use mi_accion-msg:FibonacciFeedback instead.")))

(cl:ensure-generic-function 'secuencia_actual-val :lambda-list '(m))
(cl:defmethod secuencia_actual-val ((m <FibonacciFeedback>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FibonacciFeedback>)))
  ...
  "45ba1fe6faa9dbeeb53e7cfc94979ff6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FibonacciFeedback)))
  "Returns md5sum for a message object of type 'FibonacciFeedback"
  "45ba1fe6faa9dbeeb53e7cfc94979ff6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FibonacciFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%int32[] secuencia_actual~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FibonacciFeedback)))
  "Returns full string definition for message of type 'FibonacciFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%int32[] secuencia_actual~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <FibonacciFeedback>))
  (cl:+ 0
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'secuencia_actual) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
