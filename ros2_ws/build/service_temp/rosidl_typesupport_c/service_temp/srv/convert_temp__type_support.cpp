...
static const _ConvertTemp_Request_type_support_symbol_names_t _ConvertTemp_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_temp, srv, ConvertTemp_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_temp, srv, ConvertTemp_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, service_temp, srv, ConvertTemp_Request)() {
  return &::service_temp::srv::rosidl_typesupport_c::ConvertTemp_Request_message_type_support_handle;
}
...
static const _ConvertTemp_Response_type_support_symbol_names_t _ConvertTemp_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_temp, srv, ConvertTemp_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_temp, srv, ConvertTemp_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, service_temp, srv, ConvertTemp_Response)() {
  return &::service_temp::srv::rosidl_typesupport_c::ConvertTemp_Response_message_type_support_handle;
}
...
static const _ConvertTemp_type_support_symbol_names_t _ConvertTemp_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_temp, srv, ConvertTemp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_temp, srv, ConvertTemp)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, service_temp, srv, ConvertTemp)() {
  return &::service_temp::srv::rosidl_typesupport_c::ConvertTemp_service_type_support_handle;
}
